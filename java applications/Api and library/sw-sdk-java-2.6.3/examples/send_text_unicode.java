...
/*****************************************************************
 * Shows how to send a wireless message containing Unicode text
 * in Java.
 *
...
public class send_text_unicode
{
	public static void main(String[] args) throws Exception
	{
		...
		sms.setMsgText("Hello World From Simplewire - \uC9A4!");

		// Data Coding Settings
		sms.setOptDataCoding("ucs2");
