...
/*****************************************************************
 * Shows how to send a wireless message containing an operator
 * logo in Java.
 *
...
public class send_logo
{
	public static void main(String[] args) throws Exception
	{
		...
		// Smart Message Settings - visit www.simplewire.com
		// for more information on country and network codes.
		// View the manual for more smart messaging options
		// and acceptance of raw hex data.
		sms.setOptPhone("nokia");
		sms.setOptCountryCode("Country Code goes here");
		sms.setOptNetworkCode("Network Code goes here");
		sms.setMsgOperatorLogoFilename("example.gif");
