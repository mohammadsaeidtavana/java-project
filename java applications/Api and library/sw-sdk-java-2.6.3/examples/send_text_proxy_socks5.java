 ...
 * Same as send_text except that this example adds in SOCKS 5
...
public class send_text_proxy_socks5
{
	public static void main(String[] args) throws Exception
	{
		...
		// SOCKS 5 Proxy Server Settings
		sms.setProxyType(SMS.PROXY_TYPE_SOCKS5);
