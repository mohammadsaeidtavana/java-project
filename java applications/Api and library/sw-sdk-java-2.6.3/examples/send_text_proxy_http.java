 ...
 * Same as send_text except that this example adds in HTTP proxy
 * server settings.
 *
...
public class send_text_proxy_http
{
	public static void main(String[] args) throws Exception
	{
		...
		sms.setProxyType(SMS.PROXY_TYPE_HTTP);
		sms.setProxyServer("myproxy.myserver.com");
		sms.setProxyPort(8080);
		sms.setProxyUsername("myusername");
		sms.setProxyPassword("mypassword");
		sms.setProxyRealm("myrealm");
